...
function Results() {
  ...
  const handleCopyLink = () => {
    const shareUrl = `${window.location.origin}/report/${report.shareableLink}`
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-12 flex flex-col gap-8">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => navigate('/')}
            className="border border-gray-300 text-gray-600 px-5 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition"
          >
            Check Another URL
          </button>
        </div>
